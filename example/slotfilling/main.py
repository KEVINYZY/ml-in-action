...
import example.slotfilling.load as load
from example.slotfilling.accuracy import conlleval
...
### Model
n_classes = len(idx2la)# 127个label
n_vocab = len(idx2w)# 572个词
