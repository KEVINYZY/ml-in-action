...
# 下载数据，默认的host无法打开，可以使用注释里面的新地址：http://yann.lecun.com/exdb/mnist/
mnist = input_data.read_data_sets("MNIST_data/", one_hot=True, source_url="http://yann.lecun.com/exdb/mnist/")  # 读取图片数据集
